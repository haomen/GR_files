...
class L2_DSP(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "L2 Dsp", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("L2 Dsp")
        ...
        self.settings = Qt.QSettings("GNU Radio", "L2_DSP")
        ...
        self.samp_rate = samp_rate = 16e3

        ##################################################
        # Blocks
        ##################################################
        self._samp_rate_range = Range(0, 48e3, 2e3, 16e3, 200)
...
def main(top_block_cls=L2_DSP, options=None):
