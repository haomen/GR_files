...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.channel_freq_0 = channel_freq_0 = 95.9e6
        self.channel_freq = channel_freq = 97.9e6
        self.center_freq = center_freq = 96.7e6
        self.band_width = band_width = 10e6
        ...
        # Blocks
        ##################################################
        self._channel_freq_0_range = Range(90e6, 100e6, 100e3, 95.9e6, 200)
        self._channel_freq_0_win = RangeWidget(self._channel_freq_0_range, self.set_channel_freq_0, 'Selected Frequency', "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._audio_gain_0_range = Range(0, 100, 1, 1, 200)
        self._audio_gain_0_win = RangeWidget(self._audio_gain_0_range, self.set_audio_gain_0, 'Audio Gain', "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._audio_gain_0_win)
        ...
        self.soapy_limesdr_source_0.set_bandwidth(0, band_width)
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(audio_gain_0)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, center_freq - channel_freq_0, 1, 0, 0)
        ...
        self.connect((self.soapy_limesdr_source_0, 0), (self.blocks_multiply_xx_0_0, 0))
    ...
    def set_channel_freq_0(self, channel_freq_0):
        ...
        self.analog_sig_source_x_0_0.set_frequency(self.center_freq - self.channel_freq_0)
    ...
    def set_center_freq(self, center_freq):
        ...
        self.qtgui_freq_sink_x_0_0_0.set_frequency_range(self.center_freq, self.band_width)
    ...
    def set_band_width(self, band_width):
        ...
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.center_freq, self.band_width)
        self.qtgui_freq_sink_x_0_0_0.set_frequency_range(self.center_freq, self.band_width)
        self.soapy_limesdr_source_0.set_bandwidth(0, self.band_width)
    ...
    def set_audio_gain_0(self, audio_gain_0):
        ...
        self.blocks_multiply_const_vxx_0_0.set_k(self.audio_gain_0)
