...
# Title: HackRF Listener
# Author: Hao Men
# Copyright: hmlab.io
# Description: HackRF Listerner on Auto Key
...
class hkrf_lstner(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "HackRF Listener", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("HackRF Listener")
        ...
        self.settings = Qt.QSettings("GNU Radio", "hkrf_lstner")
        ...
        # Blocks
        ##################################################
        self._freq_range = Range(300e6, 500e6, 0.5e6, 434e6, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'C:\\Users\\mitna\\Desktop\\GR_files\\hackrf_listerner_sink', False)
...
def main(top_block_cls=hkrf_lstner, options=None):
