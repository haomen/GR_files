...
class limesdr_fm_radio(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Limesdr Fm Radio", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Limesdr Fm Radio")
        ...
        self.settings = Qt.QSettings("GNU Radio", "limesdr_fm_radio")
    ...
    def set_gain1(self, gain1):
        self.gain1 = gain1
        self.soapy_limesdr_source_0.set_gain(0, min(max(self.gain1, -12.0), 61.0))
...
def main(top_block_cls=limesdr_fm_radio, options=None):
